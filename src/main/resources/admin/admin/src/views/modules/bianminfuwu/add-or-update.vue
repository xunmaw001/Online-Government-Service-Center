<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="服务名称" prop="fuwumingcheng">
					<el-input v-model="ruleForm.fuwumingcheng" placeholder="服务名称" clearable  :readonly="ro.fuwumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="服务名称" prop="fuwumingcheng">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="服务介绍" prop="fuwujieshao">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.fuwujieshao" label="服务介绍" prop="fuwujieshao">
...
export default {
	...
	this.ruleForm.fuwujieshao = this.ruleForm.fuwujieshao.replace(reg,'../../../springboot9nrlw/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
