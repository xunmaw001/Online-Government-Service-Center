<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="服务标题" prop="fuwubiaoti">
					<el-input v-model="ruleForm.fuwubiaoti" placeholder="服务标题" clearable  :readonly="ro.fuwubiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="服务标题" prop="fuwubiaoti">
					<el-input v-model="ruleForm.fuwubiaoti" placeholder="服务标题" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="服务电话" prop="fuwudianhua">
					<el-input v-model="ruleForm.fuwudianhua" placeholder="服务电话" clearable  :readonly="ro.fuwudianhua"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="服务电话" prop="fuwudianhua">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="服务内容" prop="fuwuneirong">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.fuwuneirong" label="服务内容" prop="fuwuneirong">
...
export default {
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.fuwubiaoti='身份证办理进度查询'
	...
	this.ruleForm.fuwuneirong = this.ruleForm.fuwuneirong.replace(reg,'../../../springboot9nrlw/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zhengjianchaxun/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zhengjianchaxunCrossAddOrUpdateFlag = false;
						 this.parent.search();
