<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="认证标题" prop="renzhengbiaoti">
					<el-input v-model="ruleForm.renzhengbiaoti" placeholder="认证标题" clearable  :readonly="ro.renzhengbiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="认证标题" prop="renzhengbiaoti">
					<el-input v-model="ruleForm.renzhengbiaoti" placeholder="认证标题" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="服务时间" prop="fuwushijian">
					<el-input v-model="ruleForm.fuwushijian" placeholder="服务时间" clearable  :readonly="ro.fuwushijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="服务时间" prop="fuwushijian">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="认证要求" prop="renzhengyaoqiu">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="认证要求"
					  v-model="ruleForm.renzhengyaoqiu" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.renzhengyaoqiu" label="认证要求" prop="renzhengyaoqiu">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.renzhengyaoqiu}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="认证详情" prop="renzhengxiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.renzhengxiangqing" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.renzhengxiangqing" label="认证详情" prop="renzhengxiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.renzhengxiangqing"></span>
                </el-form-item>
...
export default {
	data() {
		...
		return {
			...
			ro:{
				renzhengbiaoti : false,
				fengmian : false,
				fuwushijian : false,
				renzhengyaoqiu : false,
				renzhengxiangqing : false,
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='renzhengyaoqiu'){
							this.ruleForm.renzhengyaoqiu = obj[o];
							this.ro.renzhengyaoqiu = true;
							continue;
						}
						if(o=='renzhengxiangqing'){
							this.ruleForm.renzhengxiangqing = obj[o];
							this.ro.renzhengxiangqing = true;
							continue;
						}
						if(o=='gengxinshijian'){
	...
	this.ruleForm.renzhengxiangqing = this.ruleForm.renzhengxiangqing.replace(reg,'../../../springboot9nrlw/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiaoyupeixun/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiaoyupeixunCrossAddOrUpdateFlag = false;
						 this.parent.search();
